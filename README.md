...
Additionally, build creates the learninglocker2-docker docker image.
...
(LL application containers - api, ui, and worker - are run using image learninglocker2-docker).
